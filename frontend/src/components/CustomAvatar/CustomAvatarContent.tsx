...
import {
    ...
    customAvatarContentWatchingPopularTVDramasAndMoviesKey, followersKey, followingsKey,
    loginKey, logoutKey, personalCenterKey, recommendationServiceKey, registerKey, submissionManagementKey, worksKey
} from '@/locales/locale'
import {
    Button,
    Col,
...
import {
    ClockCircleOutlined, FireOutlined, NodeIndexOutlined,
    PlayCircleOutlined,
    PlaySquareOutlined, SelectOutlined,
    SwitcherOutlined,
    UserOutlined
            ...
            {userInfo.id ? (
                ...
                <>
                    ...
                    <Modal open={visibilityForLoginModal}
                           onOk={()=>{setVisibilityForLoginModal(false)}}
                           onCancel={()=>{setVisibilityForLoginModal(false)}}
                           onClose={()=>{setVisibilityForLoginModal(false)}}
                           footer={null}
                    >
