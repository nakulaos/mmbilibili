...
func newHistory(db *gorm.DB, opts ...gen.DOOption) history {
	...
	_history.ID = field.NewUint(tableName, "id")
	_history.CreatedAt = field.NewTime(tableName, "created_at")
	_history.UpdatedAt = field.NewTime(tableName, "updated_at")
	_history.DeletedAt = field.NewField(tableName, "deleted_at")
	_history.UID = field.NewUint(tableName, "uid")
	_history.WorkID = field.NewUint(tableName, "work_id")
	_history.Type = field.NewInt(tableName, "type")
...
func (h *history) updateTableName(table string) *history {
	...
	h.UID = field.NewUint(table, "uid")
	h.WorkID = field.NewUint(table, "work_id")
...
func (h *history) WithContext(ctx context.Context) IHistoryDo { return h.historyDo.WithContext(ctx) }

func (h history) TableName() string { return h.historyDo.TableName() }

func (h history) Alias() string { return h.historyDo.Alias() }

func (h history) Columns(cols ...field.Expr) gen.Columns { return h.historyDo.Columns(cols...) }
