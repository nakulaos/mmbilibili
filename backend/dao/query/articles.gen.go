...
func newArticle(db *gorm.DB, opts ...gen.DOOption) article {
	...
	_article.AuthorID = field.NewUint(tableName, "author_id")
	...
	_article.Categories = articleManyToManyCategories{
		db: db.Session(&gorm.Session{}),
...
type article struct {
	...
	Categories articleManyToManyCategories
...
func (a *article) updateTableName(table string) *article {
	...
	a.AuthorID = field.NewUint(table, "author_id")
...
type articleHasManyComments struct {
	db *gorm.DB
...
func (a articleHasManyComments) Where(conds ...field.Expr) *articleHasManyComments {
	if len(conds) == 0 {
		return &a
	}
...
func (a articleHasManyComments) WithContext(ctx context.Context) *articleHasManyComments {
	a.db = a.db.WithContext(ctx)
	return &a
}

func (a articleHasManyComments) Session(session *gorm.Session) *articleHasManyComments {
	a.db = a.db.Session(session)
	return &a
}

func (a articleHasManyComments) Model(m *model.Article) *articleHasManyCommentsTx {
	return &articleHasManyCommentsTx{a.db.Model(m).Association(a.Name())}
}

type articleHasManyCommentsTx struct{ tx *gorm.Association }

func (a articleHasManyCommentsTx) Find() (result []*model.Comment, err error) {
	return result, a.tx.Find(&result)
}

func (a articleHasManyCommentsTx) Append(values ...*model.Comment) (err error) {
...
func (a articleHasManyCommentsTx) Replace(values ...*model.Comment) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a articleHasManyCommentsTx) Delete(values ...*model.Comment) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a articleHasManyCommentsTx) Clear() error {
	return a.tx.Clear()
}

func (a articleHasManyCommentsTx) Count() int64 {
	return a.tx.Count()
}

type articleManyToManyCategories struct {
	db *gorm.DB
...
func (a articleManyToManyCategories) Where(conds ...field.Expr) *articleManyToManyCategories {
	if len(conds) == 0 {
		return &a
	}
...
func (a articleManyToManyCategories) WithContext(ctx context.Context) *articleManyToManyCategories {
	a.db = a.db.WithContext(ctx)
	return &a
}

func (a articleManyToManyCategories) Session(session *gorm.Session) *articleManyToManyCategories {
	a.db = a.db.Session(session)
	return &a
}

func (a articleManyToManyCategories) Model(m *model.Article) *articleManyToManyCategoriesTx {
	return &articleManyToManyCategoriesTx{a.db.Model(m).Association(a.Name())}
}

type articleManyToManyCategoriesTx struct{ tx *gorm.Association }

func (a articleManyToManyCategoriesTx) Find() (result []*model.Category, err error) {
	return result, a.tx.Find(&result)
}

func (a articleManyToManyCategoriesTx) Append(values ...*model.Category) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a articleManyToManyCategoriesTx) Replace(values ...*model.Category) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a articleManyToManyCategoriesTx) Delete(values ...*model.Category) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a articleManyToManyCategoriesTx) Clear() error {
	return a.tx.Clear()
}

func (a articleManyToManyCategoriesTx) Count() int64 {
	return a.tx.Count()
}
