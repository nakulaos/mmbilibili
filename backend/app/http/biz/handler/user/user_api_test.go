...
func TestRegister(t *testing.T) {
	...
	path := "/v1/user/register"                               // todo: you can customize query
	body := &ut.Body{Body: bytes.NewBufferString(""), Len: 1} // todo: you can customize body
	header := ut.Header{}                                     // todo: you can customize header
	w := ut.PerformRequest(h.Engine, "POST", path, body, header)
	resp := w.Result()
...
func TestUpdateUserInfo(t *testing.T) {
	h := server.Default()
	h.POST("/v1/auth/user/info", UpdateUserInfo)
	path := "/v1/auth/user/info"                              // todo: you can customize query
	body := &ut.Body{Body: bytes.NewBufferString(""), Len: 1} // todo: you can customize body
	header := ut.Header{}                                     // todo: you can customize header
	w := ut.PerformRequest(h.Engine, "POST", path, body, header)
	resp := w.Result()
...
func TestLogout(t *testing.T) {
	h := server.Default()
	h.POST("/v1/auth/user/logout", Logout)
	path := "/v1/auth/user/logout"                            // todo: you can customize query
	body := &ut.Body{Body: bytes.NewBufferString(""), Len: 1} // todo: you can customize body
	header := ut.Header{}                                     // todo: you can customize header
	w := ut.PerformRequest(h.Engine, "POST", path, body, header)
	resp := w.Result()
...
func TestFollowUser(t *testing.T) {
	h := server.Default()
	h.POST("/v1/auth/user/follow", FollowUser)
	path := "/v1/auth/user/follow"                            // todo: you can customize query
	body := &ut.Body{Body: bytes.NewBufferString(""), Len: 1} // todo: you can customize body
	header := ut.Header{}                                     // todo: you can customize header
	w := ut.PerformRequest(h.Engine, "POST", path, body, header)
	resp := w.Result()
...
func TestUserUploadFile(t *testing.T) {
	h := server.Default()
	h.POST("/v1/auth/user/upload", UserUploadFile)
	path := "/v1/auth/user/upload"                            // todo: you can customize query
	body := &ut.Body{Body: bytes.NewBufferString(""), Len: 1} // todo: you can customize body
	header := ut.Header{}                                     // todo: you can customize header
	w := ut.PerformRequest(h.Engine, "POST", path, body, header)
	resp := w.Result()
...
func TestRefreshToken(t *testing.T) {
	h := server.Default()
	h.POST("/v1/auth/user/refresh", RefreshToken)
	path := "/v1/auth/user/refresh"                           // todo: you can customize query
	body := &ut.Body{Body: bytes.NewBufferString(""), Len: 1} // todo: you can customize body
	header := ut.Header{}                                     // todo: you can customize header
	w := ut.PerformRequest(h.Engine, "POST", path, body, header)
	resp := w.Result()
