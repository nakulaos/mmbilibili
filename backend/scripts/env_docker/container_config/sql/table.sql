...
(
    ...
    push_token  varchar(255)                 null comment '推流token',
    play_token  varchar(255)                 null comment '播放token',
    partition   varchar(255)                 null comment '分区',
    id          bigint unsigned auto_increment
        primary key,
    created_at  datetime(3)                  null,
    updated_at  datetime(3)                  null,
...
(
    ...
    status     bigint unsigned default '1' not null comment '视频状态',
    copyright  varchar(255)                null comment '视频版权',
    visibility bigint unsigned default '1' not null comment '视频可见性',
