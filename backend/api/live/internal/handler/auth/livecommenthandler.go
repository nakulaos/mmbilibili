...
func LiveCommentHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.LiveCommentReq
		...
		l := auth.NewLiveCommentLogic(r.Context(), svcCtx)
		resp, err := l.LiveComment(&req)
		if err != nil {
