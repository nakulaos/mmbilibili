...
func LiveCommentListHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.LiveCommentListReq
		...
		l := common.NewLiveCommentListLogic(r.Context(), svcCtx)
		resp, err := l.LiveCommentList(&req)
		if err != nil {
