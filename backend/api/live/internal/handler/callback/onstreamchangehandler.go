...
func OnStreamChangeHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.OnStreamChangeReq
		...
		l := callback.NewOnStreamChangeLogic(r.Context(), svcCtx)
		resp, err := l.OnStreamChange(&req)
		if err != nil {
